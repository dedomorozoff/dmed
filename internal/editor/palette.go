...
func (m *Model) getPaletteCommands() []commandItem {
	cmds := []commandItem{
		...
		{id: "open_folder", title: "cmd.open_folder_t", desc: "cmd.open_folder_d", action: func(m *Model) tea.Cmd { m.startFolderBrowser(); return nil }},
		...
		{id: "duplicate_line", title: "cmd.duplicate_line_t", desc: "cmd.duplicate_line_d", action: func(m *Model) tea.Cmd { m.cur().buf.DuplicateLine(); return nil }},
		{id: "delete_line", title: "cmd.delete_line_t", desc: "cmd.delete_line_d", action: func(m *Model) tea.Cmd { m.cur().buf.DeleteLine(); return nil }},
		{id: "move_line_up", title: "cmd.move_line_up_t", desc: "cmd.move_line_up_d", action: func(m *Model) tea.Cmd { m.cur().buf.MoveLineUp(); return nil }},
