...
var enCatalog = map[string]string{
	...
	"cmd.debug_t": "Debug: Toggle Debug Panel", "cmd.debug_d": "Ctrl+Alt+D — DAP panel (Delve), F5 run, F4 breakpoint",
...
var ruCatalog = map[string]string{
	...
	"cmd.debug_t": "Отладка: Панель отладки", "cmd.debug_d": "Ctrl+Alt+D — DAP-панель (Delve), F5 запуск, F4 брейкпоинт",
