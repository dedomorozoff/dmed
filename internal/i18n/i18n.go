...
var enCatalog = map[string]string{
	...
	"cmd.debug_t": "Debug: Toggle Debug Panel", "cmd.debug_d": "Ctrl+Alt+D — DAP panel (Go/Delve by default), F5 run, F4 breakpoint",
	"msg.debug_panel_opened": "Debug panel (F5 run, F4 breakpoint, F10/F11 step, Shift+F5 stop)",
	...
	"help.debug_keys":        "breakpoint (F4), run/continue (F5), step over/in/out (F10/F11/S+F11), stop (S+F5)",
	"help.goto_def":          "go to definition (LSP)",
	"help.git_diff":          "side-by-side diff vs HEAD",
	"help.hunk":              "jump to previous / next Git hunk",
	"help.bookmark":          "toggle bookmark (Alt+M), jump next/prev (Alt+N / S+Alt+N)",
...
var ruCatalog = map[string]string{
	...
	"cmd.debug_t": "Отладка: Панель отладки", "cmd.debug_d": "Ctrl+Alt+D — DAP-панель (по умолчанию Go/Delve), F5 запуск, F4 брейкпоинт",
	"msg.debug_panel_opened": "Панель отладки (F5 запуск, F4 брейкпоинт, F10/F11 шаг, Shift+F5 стоп)",
	...
	"help.debug_keys":        "брейкпоинт (F4), запуск/продолжить (F5), шаг через/в/из (F10/F11/S+F11), стоп (S+F5)",
	...
	"help.bookmark":          "закладка (Alt+M), след./пред. закладка (Alt+N / S+Alt+N)",
