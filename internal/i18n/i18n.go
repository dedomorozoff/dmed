...
var enCatalog = map[string]string{
	...
	"ai.fix_instr":       " AI fix instruction: ",
	"ai.fix_instr_hint":  "  (Enter: start, Esc: cancel)",
	"ai.fix_streaming":   " AI fixing... ",
	"ai.fix_applied":     "AI fix applied",
	"ai.fix_discarded":   "AI fix discarded",
	...
	"cmd.toggle_breakpoint_t": "Edit: Toggle Breakpoint", "cmd.toggle_breakpoint_d": "Toggle a DAP breakpoint on the current line",
	...
	"cmd.ai_chat_t":          "AI: Toggle Chat Panel", "cmd.ai_chat_d": "Alt+A — AI chat (Ollama, OpenAI, DeepSeek, Groq, ...)",
	...
	"cmd.dap_settings_t": "Debug: DAP Settings...", "cmd.dap_settings_d": "Configure DAP adapter, launch request, program, args",
	...
	"dap.settings_hint": "(\u2191/\u2193 move, Enter edit, \u2190/\u2192 choice, Ctrl+S save, Esc close)",
	"dap.settings_save": "(Ctrl+S save, Esc close)",
	"dap.choice":        "(\u2190/\u2192 choose)",
	"msg.dap_saved":     "DAP settings saved",
	...
	"help.debug":             "debug panel (DAP; Go/Delve by default)",
	"help.debug_keys":        "breakpoint (F4), run/continue/pause (F5), step over/in/out (F6/F7/S+F7), stop (S+F5); mouse: click a thread/frame/variable, wheel walks it, Backspace leaves a variable",
	"help.debug_panel":       "in the panel: ↑↓ pick, PgUp/PgDn page, Home/End ends, +/- resizes it, l shows the console backlog",
	...
	"help.chat":              "AI chat panel (right side)",
	"help.inline":            "AI inline rewrite (select text, describe change)",
	"help.ghost":             "inline AI ghost suggestion (Tab accept, Esc dismiss)",
...
var ruCatalog = map[string]string{
	...
	"ai.fix_instr":       " AI исправление: ",
	"ai.fix_instr_hint":  "  (Enter: старт, Esc: отмена)",
	"ai.fix_streaming":   " ИИ исправляет... ",
	"ai.fix_applied":     "исправление применено",
	"ai.fix_discarded":   "исправление отклонено",
	...
	"cmd.toggle_breakpoint_t": "Правка: Переключить точку останова", "cmd.toggle_breakpoint_d": "Поставить/снять DAP-точку останова на текущей строке",
	...
	"cmd.ai_chat_t":          "AI: Чат-панель", "cmd.ai_chat_d": "Alt+A — AI-чат (Ollama, OpenAI, DeepSeek, Groq, ...)",
	...
	"cmd.dap_settings_t": "Отладка: DAP-настройки...", "cmd.dap_settings_d": "Настроить адаптер DAP, launch-запрос, программу, аргументы",
	...
	"help.debug":             "панель отладки (DAP; по умолчанию Go/Delve)",
	"help.debug_keys":        "брейкпоинт (F4), запуск/продолжить/пауза (F5), шаг через/в/из (F6/F7/S+F7), стоп (S+F5); мышь: клик по потоку/кадру/переменной, колесо — навигация, Backspace — выход из переменной",
	"help.debug_panel":       "в панели: ↑↓ — выбор, PgUp/PgDn — страница, Home/End — концы, +/- — высота, l — консоль",
	...
	"help.chat":              "AI чат-панель (справа)",
	"help.inline":            "AI inline-переписывание (выделите текст, опишите изменение)",
	"help.ghost":             "inline AI-подсказка (Tab принять, Esc отклонить)",
